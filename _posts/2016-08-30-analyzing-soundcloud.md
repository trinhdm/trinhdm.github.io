...
description: SoundCloud’s current design gets the job done, but I feel like they could make several improvements to their UX/UI. It has come a long way since I started using SoundCloud back in 2013, but their interface still feels cluttered and unclean.
categories: blog
---

<!-- old:
"I love SoundCloud."
A case study of my favorite website's UX/UI (with a mock-up redesign included). -->
...
<div style="height: 250px; margin-bottom: 15px;"><img src="/assets/img/blog_8-30_sc_navbar_profile_dropdown_old.png"  class="float-left" data-action="zoom">
...
<div class="float-right" style="margin: 10px 0 15px;">
...
<div class="float-right float-none">
...
<img src="/assets/img/blog_8-30_sc_notifications_mine.jpg" class="float-left" data-action="zoom">
...
<div class="float-right float-none" style="margin: 10px 0 15px;">
